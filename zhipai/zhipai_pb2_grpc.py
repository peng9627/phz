...
import zhipai_pb2 as zhipai__pb2
...
class ZhipaiStub(object):
    ...
    def __init__(self, channel):
        ...
        self.settle = channel.unary_unary(
            '/Zhipai/settle',
            request_serializer=zhipai__pb2.SettleData.SerializeToString,
            response_deserializer=zhipai__pb2.SettleResult.FromString,
        )
...
def add_ZhipaiServicer_to_server(servicer, server):
    rpc_method_handlers = {
        'settle': grpc.unary_unary_rpc_method_handler(
            servicer.settle,
            request_deserializer=zhipai__pb2.SettleData.FromString,
            response_serializer=zhipai__pb2.SettleResult.SerializeToString,
        ),
