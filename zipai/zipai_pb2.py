...
_SETTLEDATA = _descriptor.Descriptor(
    ...
    fields=[
        ...
        _descriptor.FieldDescriptor(
            ...
            options=None, file=DESCRIPTOR),
        _descriptor.FieldDescriptor(
            name='fangpaoUser', full_name='SettleData.fangpaoUser', index=7,
